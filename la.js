...
(function($) {
    ...
    LA_ProductGallery.prototype.initSlickslider = function() {
            ...
            responsive: [
                {
                    ...
                    settings: {
                        vertical: this.thumb_verital,
                        slidesToShow: parseInt(_thumb_column['1024'])
                    }
                },
                {
                    breakpoint: 991,
                    settings: {
                        vertical: false,
                        slidesToShow: parseInt(_thumb_column['991'])
                    }
                },
                {
                    breakpoint: 768,
                    settings: {
                        vertical: false,
                        slidesToShow: parseInt(_thumb_column['768'])
                    }
                },
                {
                    breakpoint: 600,
                    settings: {
                        vertical: false,
                        slidesToShow: parseInt(_thumb_column['600'])
                    }
                },
                {
                    breakpoint: 480,
                    settings: {
                        vertical: false,
                        slidesToShow: parseInt(_thumb_column['480'])
                    }
                }
            ]
        };
        ...
        $target.parent().LA_ImagesLoaded().then(function(){
                    ...
                    if(false !== !!$this.data('animate')){
                        ...
                        if(p_st == 'opacity:0;'){
                            if( p_st.indexOf(container_style) !== 0 ){
                                //$this.attr('style',container_style);
                                $this.css('opacity','1');
                            }
                        }
        ...
        var init_threesixy = function(){
            ...
            try {
                var $threesixy_instance = $shortcode.ThreeSixty({
                    totalFrames : opts.images.length,
                    currentFrame: 1,
                    endFrame    : opts.images.length,
    ...
    LA.core.MegaMenu = function(){
        ...
        function fix_megamenu_position( $elem, containerClass, container_width, isVerticalMenu) {
            ...
            if (!isVerticalMenu) {
                ...
                if(containerClass == 'body.helas-body'){
                    ...
                    $('li.mm-popup-wide', _that).each(function(){
                        ...
                        if( $menu_item.hasClass('mm-popup-force-fullwidth')){
                            ...
                            if(!isVerticalMenu){
                                ...
                                _containerClass = 'body.helas-body';
                            }else{
    ...
    LA.core.ElementClickEvent = function(){
        ...
        $document
            ...
            .on('click', '.btn-close-search', function(e){
                ...
                $('.handheld_component.searchbox__01').removeClass('active');
            })
        ;
        ...
        $document
            .on('click','.wc-view-toggle span',function(){
                ...
                if(!_this.hasClass('active')){
                    ...
                    Cookies.set('helas_wc_catalog_view_mode', _mode, { expires: 2 });
                }
            });
...
(function($) {
    ...
    $(function(){
        ...
        if($.exists($('#m14_testimonials .la-slick-slider'))){
            var $m14_testimonials_slider = $('#m14_testimonials .la-slick-slider'),
                m14_slick_config = $.extend({}, $m14_testimonials_slider.data('slider_config'));
            try{
                $m14_testimonials_slider.slick('destroy');
                $m14_testimonials_slider.removeAttr('data-slick_custompaging');
                m14_slick_config.customPaging = function( slide, i){
                    var targetImage = slide.$slides.eq(i).find('.testimonial_item--image').html() || '<span></span>';
                    return '<div class="custom-dots">'+targetImage+'</div>';
                };
                $m14_testimonials_slider.slick(m14_slick_config);
